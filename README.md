...
* <a href="#untemplate-documentation">Untemplate documentation</a>
  ...
  * <a href="#feature-creep">Feature Creep</a>
    ...
    * <a href="#side-scala">Side Scala</a>
...
```scala
// DO NOT HAND EDIT -- Autogenerated from 'ceci-nest-pas.md.untemplate' at 2024-01-05T05:47:18.623933Z
...
```markdown
# Ceci n'est pas... 0.42512208517819816
...
_I was published on Fri, 5 Jan 2024 00:52:17 -0500._
...
```scala
// DO NOT HAND EDIT -- Autogenerated at 2024-01-05T05:52:12.785935Z
package untemplatedoc
...
and just access your utilities directly. This is supported (as of v0.1.2).
...
package [example]:
untemplate_version [0.2.1-SNAPSHOT]:
