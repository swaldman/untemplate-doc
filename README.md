...
* <a href="#untemplate-documentation">Untemplate documentation</a>
  ...
  * <a href="#feature-creep">Feature Creep</a>
    ...
    * <a href="#untemplate-attributes">Untemplate attributes</a>
...
```scala
// DO NOT HAND EDIT -- Autogenerated from 'ceci-nest-pas.md.untemplate' at 2023-01-13T03:59:29.756506Z
...
```markdown
# Ceci n'est pas... 0.6228802545472901
...
_I was published on Thu, 12 Jan 2023 22:59:36 -0500._
...
For example, [this untemplate's](untemplatedoc/untemplate/untemplatedoc/readme/featurecreep/content-customizers.md.untemplate) header includes
