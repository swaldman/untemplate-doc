...
```scala
// DO NOT HAND EDIT -- Autogenerated from 'ceci-nest-pas.md.untemplate' at 2023-01-13T18:58:31.693634Z
...
```markdown
# Ceci n'est pas... 0.5366359008596943
...
`.untemplate`. The top-level file you are reading is is [`untemplatedoc.readme.frame-main.md.untemplate`](untemplatedoc/untemplate/untemplatedoc/readme/frame-main.untemplate), and [generates a
...
_I was published on Fri, 13 Jan 2023 13:58:34 -0500._
