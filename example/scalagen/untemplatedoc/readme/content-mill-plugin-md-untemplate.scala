// DO NOT HAND EDIT -- Autogenerated from 'content-mill-plugin.md.untemplate' at 2025-08-16T23:06:49.916733Z
...
val Untemplate_content_mill_plugin_md = new untemplate.Untemplate[Int,SubsectionMeta]:
  ...
  val UntemplateLastModified                : Option[Long] = Some(1755385537222L)
  ...
  def apply(level : Int) : untemplate.Result[SubsectionMeta] =
    val writer             : StringWriter = new StringWriter(34790)
