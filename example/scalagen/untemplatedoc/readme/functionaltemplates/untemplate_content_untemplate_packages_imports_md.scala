...
val Function_content_untemplate_packages_imports_md = new Function1[Int,untemplate.Result[SubsectionMeta]]:
  val UntemplateFunction             = this
  val UntemplateName                 = "content_untemplate_packages_imports_md"
  ...
  def apply(level : Int) : untemplate.Result[SubsectionMeta] =
    val writer             : StringWriter = new StringWriter(4030)
...
end Function_content_untemplate_packages_imports_md

def content_untemplate_packages_imports_md(level : Int) : untemplate.Result[SubsectionMeta] = Function_content_untemplate_packages_imports_md( level )
