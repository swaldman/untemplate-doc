// DO NOT HAND EDIT -- Autogenerated from 'content-quickstart.md.untemplate' at 2023-01-14T19:00:25.259138Z
...
val Untemplate_content_quickstart_md = new untemplate.Untemplate[Int,SubsectionMeta]:
  ...
  def apply(level : Int) : untemplate.Result[SubsectionMeta] =
    val writer             : StringWriter = new StringWriter(43490)
    ...
    writer.write(box(None,Some("Exercise 1: Supply untemplate input"))( exercise1() ))
    ...
    writer.write(box(None,Some("Exercise 2: Write your own!"))( exercise2() ))
