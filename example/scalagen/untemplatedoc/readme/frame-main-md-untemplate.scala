// DO NOT HAND EDIT -- Autogenerated from 'frame-main.md.untemplate' at 2025-08-16T22:57:44.783280Z
...
val Untemplate_frame_main_md = new untemplate.Untemplate[immutable.Map[String,Any],Nothing]:
  ...
  val UntemplateLastModified                : Option[Long] = Some(1755385011633L)
  ...
  def apply(input : immutable.Map[String,Any] = immutable.Map.empty) : untemplate.Result[Nothing] =
    val writer             : StringWriter = new StringWriter(21920)
    ...
    val millPlugin               : untemplate.Result[SubsectionMeta] = content_mill_plugin_md( level + 1 )
