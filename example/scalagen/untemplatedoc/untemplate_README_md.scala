...
val Function_README_md = new Function1[immutable.Map[String,Any],untemplate.Result[Nothing]]:
  ...
  def apply(input : immutable.Map[String,Any]) : untemplate.Result[Nothing] =
    val writer     : StringWriter = new StringWriter(19488)
