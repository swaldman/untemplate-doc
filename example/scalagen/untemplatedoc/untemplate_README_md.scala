...
def README_md(input : immutable.Map[String,Any]) : String =
  ...
  writer.writeln(Files.readString(ceci2Src).trim)
    val block3 = new Function2[immutable.Map[String,Any],mutable.Map[String,Any],String]:
      def apply( input : immutable.Map[String,Any], scratchpad : mutable.Map[String,Any]) : String =
    ...
    writer.write(block3( input, scratchpad ))
    
  writer.writeln(untemplatedoc.ceci_nest_pas2_md(immutable.Map.empty))
    val block4 = new Function2[immutable.Map[String,Any],mutable.Map[String,Any],String]:
      def apply( input : immutable.Map[String,Any], scratchpad : mutable.Map[String,Any]) : String =
    ...
    writer.write(block4( input, scratchpad ))
    
  writer.writeln(Files.readString(loopySrc).trim)
    val block5 = new Function2[immutable.Map[String,Any],mutable.Map[String,Any],String]:
      def apply( input : immutable.Map[String,Any], scratchpad : mutable.Map[String,Any]) : String =
        "```\n\nLet's get a look at what it produces:\n```markdown\n"
    writer.write(block5( input, scratchpad ))
    
  writer.writeln(untemplatedoc.loopy_md(immutable.Map.empty))
    val block6 = new Function2[immutable.Map[String,Any],mutable.Map[String,Any],String]:
      def apply( input : immutable.Map[String,Any], scratchpad : mutable.Map[String,Any]) : String =
        "```\n\nAnd again!\n```markdown\n"
    writer.write(block6( input, scratchpad ))
    
  writer.writeln(untemplatedoc.loopy_md(immutable.Map.empty))
    val block7 = new Function2[immutable.Map[String,Any],mutable.Map[String,Any],String]:
      def apply( input : immutable.Map[String,Any], scratchpad : mutable.Map[String,Any]) : String =
        "```\n\n### Blocks are (isolated?) functions?\n\nI think I'm going to experiment with this a bit more before \"documenting\" it.\n\n"
    writer.write(block7( input, scratchpad ))
