...
val Function_README_some_simple_untemplates_md = new Function1[Int,untemplate.Result[Subsection]]:
  ...
  def apply(level : Int) : untemplate.Result[Subsection] =
    val writer     : StringWriter = new StringWriter(4692)
